export default function About() {
  ...
  return (
    <>
      ...
      <p>
        To collaborate, learn together, and build games they choose — from idea to completion.
      </p>
      ...
      <ul>
        ...
        <li>During development, you'll be working with people in other field of interest (art/music/coding) to bring your ideas to life</li>
      </ul>
      ...
      <ul>
        <li>Games often take a lot longer to complete than initial expectated duration</li>
